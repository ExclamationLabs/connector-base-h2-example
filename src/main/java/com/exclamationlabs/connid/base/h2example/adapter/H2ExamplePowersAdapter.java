...
public class H2ExamplePowersAdapter extends BaseAdapter<H2ExamplePower, H2ExampleConfiguration> {
  ...
  @Override
  protected H2ExamplePower constructModel(
    ...
    power.setName(
        AdapterValueTypeConverter.getSingleAttributeValue(String.class, attributes, POWER_NAME));
    power.setDescription(
        AdapterValueTypeConverter.getSingleAttributeValue(
            String.class, attributes, POWER_DESCRIPTION));
    return power;
  }
